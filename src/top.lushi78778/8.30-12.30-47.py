...
"""
@File     : 8.30-12.30-47.py
@Project  : useful
@Time     : 2021/10/25 10:14
@Author   : lushi
@Contact  : lushi78778@outlook.com
@Software : PyCharm
@Last Modify Time      @Version     @Desciption
------------------     --------     -----------
2021/10/25 10:14        1.0             None
"""
...
num_room = '5966'
num_sit = '/html/body/div/div[2]/ul/li[47]'
...
def load_userdata():
    ...
    browser.find_element_by_class_name('ipt-tel').send_keys('18713578778')
    browser.find_element_by_class_name("ipt-pwd").send_keys('12345687.')
    time.sleep(0.3)
